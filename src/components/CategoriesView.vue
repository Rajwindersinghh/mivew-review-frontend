            ...
            <div v-for="category in categories" :key="category.name">
                ...
                <div class="product-list">
                    <div v-for="post in category.posts"
                         :key="post.id"
                         class="product-card dark-theme"
                         @click="viewReview(post)">
                        <div class="product-image">
                            <img :src="post.imageUrl" alt="Post Image" />
                        </div>
                        <div class="product-details">
                            <h2 class="text-white1">{{ post.title }}</h2>
                            <p class="text-white1">
                                <strong>Category:</strong> {{ post.category }}
                            </p>
                            <div class="review-stars">
                                <strong class="text-white1">Rating: </strong>
                    ...
                    if (Array.isArray(response.data)) {
                        const allPosts = await Promise.all(
                            response.data.map(async (post) => ({
                                ...
                                category: await this.getCategories(post.categories),
